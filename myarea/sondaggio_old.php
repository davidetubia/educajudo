...
<form class="rating mt-5">

<div class="container">
    <h1>VALUTA LA TUA ESPERIENZA DI FORMAZIONE</h1>
    <p>
    Caro/a corsista,
    ti chiediamo di compilare il seguente breve questionario che costituisce uno strumento prezioso per valutare l’attività svolta
    e migliorare le future iniziative.
    </p>
<style>
    h3 small{
        font-weight: normal;
