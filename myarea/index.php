<?php include 'header.php'; ?>
    <div class="w-100 mt-5">
        ...
        <div class="video-pre-corso d-flex flex-column flex-md-row align-items-center">
            ...
            <div class="info">
                ...
                <h4>Presidente Federazione Italiana Judo Lotta Karate e Arti Marziali<h4>
                <h3>Domenico Falcone</h3>
            </div>
        </div>

        <div class="video-pre-corso d-flex flex-column flex-md-row align-items-center">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/dtP_oSFT0CU?controls=0&showinfo=0&rel=0&modestbranding=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <div class="info">
                <h3 class="text-violet mt-3">Indirizzi sanitari</h3>
                <h4>Direzione Generale Nazionale Sanitaria<h4>
    ...
    <div class="bg-gray py-3 mt-4">
    <div class="container">
        <h2 class="text-white text-center">Organismi internazionali</h2>
